...
import type { Training, PlayerProfile, PlayerTraining } from "@prisma/client";
import {
  Table,
  TableBody,
  TableCell,
...
interface TrainingTableProps {
    ...
    playerProfile: PlayerProfile & { trainings: PlayerTraining[] };
}

export function TrainingTable({ trainingCatalog, playerProfile }: TrainingTableProps) {
